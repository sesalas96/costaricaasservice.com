module github.com/devsebas/saascr/interop/cri-svc-interop-audit
...
require (
	github.com/devsebas/saascr/libs/cri-lib-crypto v0.0.0
...
replace github.com/devsebas/saascr/libs/cri-lib-crypto => ../../libs/cri-lib-crypto
