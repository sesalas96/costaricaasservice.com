module github.com/devsebas/costaricaasservice/interop/cri-svc-interop-audit
...
require (
	github.com/devsebas/costaricaasservice/libs/cri-lib-crypto v0.0.0
...
replace github.com/devsebas/costaricaasservice/libs/cri-lib-crypto => ../../libs/cri-lib-crypto
