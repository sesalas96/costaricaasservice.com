// Binary api arranca el cri-svc-mtss (CCSS member mock).
package main
...
import (
	...
	"github.com/devsebas/costaricaasservice/members/cri-svc-mtss/internal/config"
	"github.com/devsebas/costaricaasservice/members/cri-svc-mtss/internal/handlers"
...
func main() {
	...
	icli := interop.New(cfg.SecurityServer, "mtss")
