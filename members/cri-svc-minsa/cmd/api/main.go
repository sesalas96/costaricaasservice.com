// Binary api arranca el cri-svc-minsa (CCSS member mock).
package main
...
import (
	...
	"github.com/devsebas/costaricaasservice/members/cri-svc-minsa/internal/config"
	"github.com/devsebas/costaricaasservice/members/cri-svc-minsa/internal/handlers"
...
func main() {
	...
	icli := interop.New(cfg.SecurityServer, "minsa")
