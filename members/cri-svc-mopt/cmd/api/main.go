// Binary api arranca el cri-svc-mopt (CCSS member mock).
package main
...
import (
	...
	"github.com/devsebas/costaricaasservice/members/cri-svc-mopt/internal/config"
	"github.com/devsebas/costaricaasservice/members/cri-svc-mopt/internal/handlers"
...
func main() {
	...
	icli := interop.New(cfg.SecurityServer, "mopt")
