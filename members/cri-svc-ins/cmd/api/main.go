// Binary api arranca el cri-svc-ins (CCSS member mock).
package main
...
import (
	...
	"github.com/devsebas/costaricaasservice/members/cri-svc-ins/internal/config"
	"github.com/devsebas/costaricaasservice/members/cri-svc-ins/internal/handlers"
...
func main() {
	...
	icli := interop.New(cfg.SecurityServer, "ins")
