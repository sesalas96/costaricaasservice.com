// Binary api arranca el cri-svc-migracion (CCSS member mock).
package main
...
import (
	...
	"github.com/devsebas/costaricaasservice/members/cri-svc-migracion/internal/config"
	"github.com/devsebas/costaricaasservice/members/cri-svc-migracion/internal/handlers"
...
func main() {
	...
	icli := interop.New(cfg.SecurityServer, "migracion")
