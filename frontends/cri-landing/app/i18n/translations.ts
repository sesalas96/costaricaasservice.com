      ...
      cases: [
        {
          ...
          body: "Hacienda construye la declaración consultando salarios al patrono, cargas a la CCSS y composición familiar a Reg.Civil — todo vía Conecta. El ciudadano abre MiCR, revisa y firma con un toque. De semanas a 90 segundos.",
          actors: "Hacienda · CCSS · Reg.Civil · MiCR",
          category: "gobierno",
        },
        {
          tag: "MOPT · INS",
          title: "Marchamo y SOA en una transacción",
          body: "MOPT confirma el padrón vehicular, el INS calcula la prima y emite el SOA firmado, Hacienda cobra todo por SINPE. El sticker digital queda en MiCR — los oficiales lo validan con QR.",
          actors: "MOPT · INS · Hacienda · BCCR",
          category: "gobierno",
        },
        {
          tag: "Reg.Nacional",
          title: "Compra-venta inmobiliaria sin notario físico",
          body: "Reg.Nacional valida titularidad y gravámenes, la Muni revisa deuda municipal, Hacienda cobra traspaso, BCCR transfiere por SINPE y vos firmás la escritura CAdES con tu Ed25519. Tiempo total: segundos.",
          actors: "Reg.Nacional · Muni · Hacienda · BCCR · iduc",
          category: "gobierno",
        },
        {
          tag: "Reg.Nacional · SUGEF",
          title: "Constituir sociedad en 8 minutos",
          body: "Reg.Nacional inscribe la S.A., Hacienda asigna NITE, CCSS abre patronal, MTSS queda notificado y SUGEF detecta si la actividad necesita autorización. De un día a ocho minutos.",
          actors: "Reg.Nacional · Hacienda · CCSS · MTSS · SUGEF",
          category: "gobierno",
        },
        {
          tag: "Muni · Bomberos",
          title: "Permiso constructivo unificado",
          body: "La Muni revisa zonificación, Bomberos valida seguridad humana, AyA confirma capacidad hídrica, ICE valida carga eléctrica y MINAE da el visto ambiental. Cinco visados, una sola firma.",
          actors: "Muni · Bomberos · AyA · ICE · MINAE",
          category: "gobierno",
        },
        {
          tag: "Compras",
        ...
        {
          tag: "PROCOMER",
          title: "Exportar sin papeles",
          body: "El exportador firma la DUA digital, Hacienda valida aranceles, PROCOMER emite certificado de origen y BCCR confirma ingreso de divisas. La aduana destino verifica la firma vía Conecta — cero PDFs, cero ventanillas.",
          actors: "PROCOMER · Hacienda · BCCR · iduc",
          category: "gobierno",
        },
        {
          tag: "Migración",
          title: "Pasaporte sin papeles",
          body: "Migración verifica identidad con e-ID, antecedentes migratorios y cobra el arancel a Hacienda en una sola conversación. El ciudadano agenda la entrega y firma digitalmente — sin formularios.",
          actors: "Migración · Reg.Civil · Hacienda · iduc",
          category: "identidad",
        },
        {
          tag: "Once-only",
          title: "Cambio de domicilio · una sola vez",
          body: "El ciudadano actualiza su dirección en Reg.Civil. Hacienda, CCSS, INS y MEP reciben el cambio en tiempo real vía Kafka. Nunca más cargar comprobantes en cada ventanilla.",
          actors: "Reg.Civil → Hacienda · CCSS · INS · MEP",
          category: "identidad",
        },
        {
          tag: "Eventos vitales",
          title: "Activar todo al nacer un hijo",
          body: "El hospital CCSS publica el evento. Reg.Civil emite cédula provisional, PANI registra al menor, IMAS recalcula el bono familiar y Hacienda actualiza dependientes. El padre solo enfoca en el bebé.",
          actors: "CCSS · Reg.Civil · PANI · IMAS · Hacienda",
          category: "identidad",
        },
        {
          tag: "Banca",
          title: "KYC bancario verificable",
          body: "Un banco (member) abre cuenta verificando identidad con e-ID, antecedentes vía Conecta y sanciones SUGEF. Sin pasaporte, sin recibos de servicios, sin esperar 48 horas.",
          actors: "Banco · iduc · Reg.Civil · SUGEF",
          category: "identidad",
        },
        {
          tag: "MEP",
          title: "Título académico verificable",
          body: "El MEP emite el bachillerato firmado con Ed25519 al cerrar el ciclo. La universidad o el patrono lo valida vía Conecta sin pedirle al egresado un PDF escaneado. Cero falsificaciones posibles.",
          actors: "MEP · iduc · empleador",
          category: "identidad",
        },
        {
          tag: "MICITT · ICE",
          title: "Portabilidad numérica con un toque",
          body: "El usuario solicita cambio de operador en MiCR, MICITT coordina, ICE libera y el operador nuevo activa — todo verificando identidad con e-ID. Sin oficinas, sin papeles, sin esperar 48 horas.",
          actors: "MICITT · ICE · operador · iduc",
          category: "identidad",
        },
        {
          tag: "Salud",
          title: "Receta médica electrónica",
          body: "La CCSS emite la receta firmada por el médico con Ed25519, sellada RFC 3161. Cualquier farmacia conectada — pública o privada — la valida con QR antes de despachar. Histórico clínico siempre en MiCR.",
          actors: "CCSS · iduc · farmacia",
          category: "bienestar",
        },
        {
          tag: "Social",
          title: "Beneficios sociales sin trámite",
          body: "IMAS calcula elegibilidad consultando ingresos en Hacienda, composición familiar en Reg.Civil y aseguramiento en CCSS. El solicitante no presenta nada — once-only en su forma más pura.",
          actors: "IMAS · Hacienda · Reg.Civil · CCSS",
          category: "bienestar",
        },
        {
          tag: "MINSA · MEP",
          title: "Vacuna y matrícula en un mismo acto",
          body: "MINSA registra la dosis, CCSS la guarda en historial clínico, el carné digital se firma con Ed25519 y MEP libera el cupo de guardería al validar el esquema. Carné nacional verificable con QR.",
          actors: "MINSA · CCSS · MEP · iduc",
          category: "bienestar",
        },
        {
          tag: "Beca",
          title: "Beca por mérito y necesidad sin formulario",
          body: "MEP confirma promedio académico, IMAS valida vulnerabilidad económica con datos de Hacienda y BCCR programa el desembolso mensual por SINPE. La familia se entera ya aprobada.",
          actors: "MEP · IMAS · Hacienda · BCCR",
          category: "bienestar",
        },
        {
          tag: "Pensión",
          title: "Pensión por sobrevivencia activa al fallecer",
          body: "El hospital CCSS registra el deceso. Reg.Civil cierra la cédula, INS reconoce indemnización si aplica y CCSS activa la pensión a beneficiarios validando vínculo familiar. Sin trámites en duelo.",
          actors: "CCSS · Reg.Civil · INS · BCCR",
          category: "bienestar",
        },
        {
          tag: "Justicia",
          title: "Denuncia policial firmada",
          body: "Fuerza Pública toma la denuncia en MiCR, Poder Judicial asigna expediente, vos firmás con Ed25519 sellado RFC 3161 y queda en bitácora pública. Sin filas en delegaciones, valor probatorio preservado.",
          actors: "Fuerza Pública · Poder Judicial · iduc",
          category: "justicia",
        },
        {
          tag: "Notificaciones",
          title: "Notificación judicial electrónica",
          body: "Los tribunales envían citaciones a MiCR con valor legal equivalente al físico. Acuse de recibo criptográfico, trazabilidad completa para el juzgado. Cero edictos en La Gaceta.",
          actors: "Poder Judicial · notifications · firma",
          category: "justicia",
        },
        {
          tag: "Laboral",
          title: "Liquidación laboral validada",
          body: "El patrono propone la liquidación, MTSS valida cálculo según Código de Trabajo, CCSS confirma cotizaciones reportadas y BCCR acredita por SINPE. Si hay disputa, queda lista para el juzgado laboral.",
          actors: "MTSS · CCSS · BCCR · Poder Judicial",
          category: "justicia",
        },
        {
          tag: "Democracia",
          title: "Voto electrónico verificable",
          body: "El TSE valida identidad e-ID, registra el voto firmado y publica un resumen Merkle de la jornada. Cada votante puede verificar que su voto fue contado — sin revelar por quién votó.",
      ...
      cases: [
        {
          ...
          body: "Tax builds the return by querying the employer for wages, Healthcare for contributions and Civil Reg. for household composition — all over Conecta. The citizen opens MiCR, reviews and signs with one tap. From weeks to 90 seconds.",
          actors: "Tax · Healthcare · Civil Reg. · MiCR",
          category: "gobierno",
        },
        {
          tag: "Transport · Insurance",
          title: "Road tag and mandatory insurance in one transaction",
          body: "Transport confirms the vehicle registry, Insurance computes the premium and issues the signed mandatory policy, Tax collects everything via SINPE. The digital sticker lives in MiCR — traffic officers validate it via QR.",
          actors: "Transport · Insurance · Tax · Central Bank",
          category: "gobierno",
        },
        {
          tag: "Nat. Registry",
          title: "Real-estate purchase, no physical notary",
          body: "Nat. Registry validates title and liens, City checks municipal debt, Tax computes transfer duty, Central Bank settles via SINPE and you sign the CAdES deed with your Ed25519 key. Total time: seconds.",
          actors: "Nat. Registry · City · Tax · Central Bank · iduc",
          category: "gobierno",
        },
        {
          tag: "Nat. Registry · Fin. Oversight",
          title: "Incorporate a company in 8 minutes",
          body: "Nat. Registry incorporates, Tax assigns the fiscal ID, Healthcare opens employer payroll, Labor is notified and Fin. Oversight detects whether the activity needs authorization. From a day to eight minutes.",
          actors: "Nat. Registry · Tax · Healthcare · Labor · Fin. Oversight",
          category: "gobierno",
        },
        {
          tag: "City · Fire",
          title: "Unified construction permit",
          body: "City reviews zoning, Fire approves human safety, Water confirms hydric capacity, Power confirms electrical load and Environment grants ecological clearance. Five sign-offs, one signature.",
          actors: "City · Fire · Water · Power · Environment",
          category: "gobierno",
        },
        {
          tag: "Procurement",
        ...
        {
          tag: "Foreign Trade",
          title: "Paperless export",
          body: "The exporter signs the digital customs declaration, Tax validates duties, Foreign Trade issues the certificate of origin and Central Bank confirms FX inflow. Destination customs verifies the signature over Conecta — zero PDFs, zero counters.",
          actors: "Foreign Trade · Tax · Central Bank · iduc",
          category: "gobierno",
        },
        {
          tag: "Immigration",
          title: "Paperless passport",
          body: "Immigration verifies identity with e-ID, migratory record and collects the fee from Tax in a single conversation. The citizen books pickup and signs digitally — no forms.",
          actors: "Immigration · Civil Reg. · Tax · iduc",
          category: "identidad",
        },
        {
          tag: "Once-only",
          title: "Address change · once and done",
          body: "The citizen updates their address in Civil Reg. Tax, Healthcare, Insurance and Education receive the change in real time over Kafka. No more uploaded utility bills at every counter.",
          actors: "Civil Reg. → Tax · Healthcare · Insurance · Education",
          category: "identidad",
        },
        {
          tag: "Vital events",
          title: "Activate everything at birth",
          body: "The Healthcare hospital publishes the event. Civil Reg. issues provisional ID, Child Welfare registers the minor, Welfare recomputes the family benefit and Tax updates dependents. The parent only focuses on the baby.",
          actors: "Healthcare · Civil Reg. · Child Welfare · Welfare · Tax",
          category: "identidad",
        },
        {
          tag: "Banking",
          title: "Verifiable bank KYC",
          body: "A bank (member) opens an account by verifying identity with e-ID, background over Conecta and sanctions at Fin. Oversight. No passport scans, no utility bills, no 48-hour wait.",
          actors: "Bank · iduc · Civil Reg. · Fin. Oversight",
          category: "identidad",
        },
        {
          tag: "Education",
          title: "Verifiable academic credentials",
          body: "Education issues the high-school diploma signed with Ed25519 at graduation. The university or employer validates it over Conecta without asking the graduate for a scanned PDF. Forgery becomes impossible.",
          actors: "Education · iduc · employer",
          category: "identidad",
        },
        {
          tag: "Telecom · Power",
          title: "Number portability with one tap",
          body: "The user requests carrier change in MiCR, the telecom regulator coordinates, Power releases the line and the new carrier activates — all by verifying identity with e-ID. No offices, no paperwork, no 48-hour wait.",
          actors: "Telecom Reg. · Power · carrier · iduc",
          category: "identidad",
        },
        {
          tag: "Health",
          title: "Electronic prescription",
          body: "Healthcare issues the prescription signed by the physician with Ed25519 and an RFC 3161 timestamp. Any connected pharmacy — public or private — validates it via QR before dispensing. Clinical history always in MiCR.",
          actors: "Healthcare · iduc · pharmacy",
          category: "bienestar",
        },
        {
          tag: "Welfare",
          title: "Social benefits, no application",
          body: "Welfare computes eligibility by querying income at Tax, household composition at Civil Reg. and insurance at Healthcare. The applicant submits nothing — once-only at its purest.",
          actors: "Welfare · Tax · Civil Reg. · Healthcare",
          category: "bienestar",
        },
        {
          tag: "Health Min. · Education",
          title: "Vaccine and enrollment in one act",
          body: "Health Min. records the dose, Healthcare files it in clinical history, the digital card is signed with Ed25519 and Education releases the daycare slot once the schedule validates. Nationally verifiable card with QR.",
          actors: "Health Min. · Healthcare · Education · iduc",
          category: "bienestar",
        },
        {
          tag: "Scholarship",
          title: "Merit + need scholarship, no form",
          body: "Education confirms academic average, Welfare validates economic vulnerability with Tax data and Central Bank schedules the monthly disbursement via SINPE. The family gets notified once already approved.",
          actors: "Education · Welfare · Tax · Central Bank",
          category: "bienestar",
        },
        {
          tag: "Pension",
          title: "Survivor pension active at death",
          body: "The Healthcare hospital records the passing. Civil Reg. closes the ID, Insurance recognizes indemnification if applicable and Healthcare activates the pension to beneficiaries by validating kinship. No paperwork during grief.",
          actors: "Healthcare · Civil Reg. · Insurance · Central Bank",
          category: "bienestar",
        },
        {
          tag: "Justice",
          title: "Signed police report",
          body: "Public Force takes the report in MiCR, Judiciary assigns a case, you sign with Ed25519 and an RFC 3161 timestamp and it lands in the public log. No queues at police stations, evidentiary value preserved.",
          actors: "Public Force · Judiciary · iduc",
          category: "justicia",
        },
        {
          tag: "Notifications",
          title: "Electronic court service",
          body: "Courts deliver subpoenas to MiCR with the same legal weight as physical service. Cryptographic delivery receipt, full traceability for the court. Zero gazette notices.",
          actors: "Judiciary · notifications · signing",
          category: "justicia",
        },
        {
          tag: "Labor",
          title: "Validated severance",
          body: "The employer proposes severance, Labor validates the calculation against the Labor Code, Healthcare confirms reported contributions and Central Bank credits via SINPE. If disputed, it's ready for the labor court.",
          actors: "Labor · Healthcare · Central Bank · Judiciary",
          category: "justicia",
        },
        {
          tag: "Democracy",
          title: "Verifiable electronic vote",
          body: "Electoral validates identity with e-ID, records the signed ballot and publishes a Merkle summary of the day. Each voter can verify their ballot was counted — without revealing how they voted.",
